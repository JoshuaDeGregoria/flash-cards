...
state_shapes = {
    ...
    # ── NORTHWEST ────────────────────────────────────────────
    "WA": [(-124.73,48.38), (-124.40,48.00), (-124.02,47.50), (-123.40,47.20), (-122.80,46.80), (-122.30,46.60),
           (-121.50,45.70), (-120.00,45.80), (-119.00,45.90), (-117.90,46.40), (-117.03,46.00), (-117.03,49.00),
           (-124.73,49.00), (-124.73,48.38)],

    "OR": [(-124.55,46.25), (-124.20,46.10), (-124.00,45.80), (-123.80,45.50), (-123.50,45.20), (-123.00,44.80),
           (-122.50,44.50), (-121.80,44.20), (-120.50,44.00), (-118.50,43.80), (-117.03,42.00), (-117.03,46.00),
           (-124.55,46.25)],

    "CA": [(-124.41,42.00), (-123.80,41.80), (-123.50,41.40), (-123.00,40.80), (-122.80,40.40), (-122.50,39.80),
           (-122.40,39.00), (-122.20,38.20), (-122.00,37.50), (-121.80,36.80), (-121.50,36.00), (-120.90,35.40),
           (-120.50,34.80), (-120.00,34.20), (-119.50,33.80), (-118.80,33.40), (-118.20,33.00), (-117.50,32.70),
           (-117.24,32.53), (-116.50,32.70), (-115.80,33.20), (-115.00,34.00), (-114.63,35.00), (-114.63,32.53),
           (-120.00,42.00), (-124.41,42.00)],

    # ── MOUNTAIN ─────────────────────────────────────────────
    "NV": [(-120.00,42.00), (-119.00,42.00), (-118.00,41.50), (-117.00,41.00), (-116.00,40.50), (-115.00,39.50),
           (-114.63,37.00), (-114.63,35.00), (-120.00,39.00), (-120.00,42.00)],

    "ID": [(-117.03,49.00), (-116.90,48.80), (-116.50,48.00), (-116.00,47.00), (-115.50,45.80), (-115.00,45.00),
           (-114.60,44.50), (-114.05,42.00), (-111.05,42.00), (-111.05,49.00), (-117.03,49.00)],

    "MT": [(-116.05,49.00), (-115.00,49.00), (-114.00,48.80), (-113.00,48.00), (-112.00,47.00), (-111.00,46.00),
           (-110.00,45.50), (-109.00,45.00), (-104.04,44.36), (-104.04,49.00), (-116.05,49.00)],

    "WY": [(-111.05,45.00), (-110.50,44.80), (-110.00,44.50), (-109.50,43.50), (-109.00,42.50), (-108.00,42.00),
           (-107.00,41.50), (-106.00,41.00), (-105.00,41.00), (-104.05,41.00), (-104.05,45.00), (-111.05,45.00)],

    "CO": [(-109.05,41.00), (-108.50,40.80), (-108.00,39.50), (-107.50,38.50), (-107.00,37.50), (-106.00,37.00),
           (-105.00,37.00), (-104.00,37.00), (-102.05,37.00), (-102.05,41.00), (-109.05,41.00)],

    "UT": [(-114.05,42.00), (-113.50,41.80), (-113.00,41.00), (-112.50,40.50), (-112.00,40.00), (-111.05,41.00),
           (-110.00,40.50), (-109.05,37.00), (-114.05,37.00), (-114.05,42.00)],

    "AZ": [(-114.82,37.00), (-114.00,36.50), (-113.50,35.50), (-113.00,34.50), (-112.50,33.50), (-112.00,32.50),
           (-111.50,32.00), (-111.07,31.33), (-114.82,32.49), (-114.82,37.00)],

    # New Mexico has a notched bottom-left corner (the "boot heel")
    "NM": [(-109.05,37.00), (-108.50,36.80), (-108.00,36.00), (-107.50,35.00), (-107.00,34.00), (-106.62,32.00),
           (-106.00,32.00), (-105.00,32.00), (-103.00,32.00), (-103.00,37.00), (-109.05,37.00)],

    # ── GREAT PLAINS ─────────────────────────────────────────
    "ND": [(-104.05,49.00), (-103.00,49.00), (-102.00,48.80), (-101.00,48.50), (-100.00,48.00), (-99.00,47.50),
           (-98.00,47.00), (-97.00,46.93), (-96.56,46.63), (-104.05,45.93), (-104.05,49.00)],

    "SD": [(-104.05,45.93), (-103.00,45.90), (-102.00,45.50), (-101.00,45.00), (-100.00,44.50), (-99.00,44.00),
           (-98.00,43.50), (-97.00,43.00), (-96.44,43.00), (-96.44,45.93), (-104.05,45.93)],

    "NE": [(-104.05,43.00), (-103.00,42.80), (-102.05,40.00), (-101.00,40.00), (-100.00,40.00), (-99.00,40.00),
           (-98.00,40.00), (-97.00,40.00), (-96.00,40.00), (-95.31,40.00), (-95.37,42.49), (-104.05,43.00)],

    "KS": [(-102.05,40.00), (-101.00,40.00), (-100.00,39.80), (-99.00,39.50), (-98.00,39.00), (-97.00,38.50),
           (-96.00,38.00), (-95.00,37.50), (-94.62,37.00), (-102.05,37.00)],

    # Oklahoma has a rectangular panhandle sticking out to the west
    "OK": [(-103.00,37.00), (-102.00,36.80), (-101.00,36.70), (-100.00,36.50), (-99.00,36.40), (-98.00,36.30),
           (-97.00,36.20), (-96.00,36.10), (-94.43,36.50), (-94.43,33.64), (-103.00,33.64)],

    # Texas is one of the most complex shapes: panhandle at top,
    # wide body, Gulf Coast at bottom, and the Rio Grande on the west
    "TX": [(-103.00,36.50), (-102.00,36.40), (-101.00,36.20), (-100.00,36.00), (-99.50,35.50), (-99.00,34.50),
           (-98.50,33.50), (-98.00,32.50), (-97.50,31.50), (-97.00,30.00), (-96.40,28.30), (-95.50,27.00),
           (-94.80,26.00), (-94.00,25.84), (-97.14,26.15), (-99.00,27.00), (-100.00,28.00), (-101.00,29.00),
           (-102.00,30.00), (-103.00,31.00), (-104.57,30.08), (-106.62,32.00), (-103.00,32.00)],

    # ── MIDWEST ──────────────────────────────────────────────
    "MN": [(-97.24,49.00), (-96.50,48.80), (-95.50,48.00), (-94.50,47.00), (-93.50,46.00), (-92.50,45.50),
           (-91.50,45.00), (-90.50,44.50), (-89.49,45.30), (-89.49,43.50), (-97.24,43.50), (-97.24,49.00)],
    ...
    "MI": [
        ...
        [(-86.60,41.77), (-86.00,42.00), (-85.50,42.50), (-85.00,43.00), (-84.50,43.50), (-84.00,44.00),
         (-83.80,44.77), (-83.45,45.00), (-83.00,45.50), (-82.80,45.80), (-82.43,43.00), (-82.43,41.77),
         (-86.60,41.77)],
        # Upper Peninsula
        [(-90.42,48.19), (-89.50,47.80), (-88.50,47.00), (-87.50,46.50), (-86.50,46.00), (-85.50,46.00),
         (-84.50,46.00), (-84.00,46.50), (-84.50,47.00), (-90.42,48.19)],
    ],
    ...
    "FL": [(-87.63,30.99), (-86.50,30.90), (-85.50,30.50), (-84.90,29.70), (-84.00,29.20), (-83.30,29.00),
           (-82.50,28.50), (-81.80,28.00), (-81.20,27.50), (-80.80,27.00), (-80.40,26.50), (-80.20,26.00),
           (-80.03,25.13), (-80.50,25.50), (-81.00,26.00), (-81.50,26.50), (-82.00,27.00), (-82.65,28.00),
           (-83.50,29.00), (-84.50,30.00), (-85.50,30.50), (-87.63,30.40)],
    ...
    "NY": [(-79.76,43.00), (-79.00,43.50), (-78.00,44.00), (-77.00,44.50), (-76.00,44.80), (-75.00,45.00),
           (-74.00,45.01), (-73.77,45.01), (-73.50,44.50), (-73.00,43.50), (-72.50,42.50), (-73.54,40.75),
           (-74.25,41.00), (-75.00,42.00), (-79.76,42.27)],
    ...
    "ME": [(-71.08,45.31), (-70.50,45.00), (-70.00,44.50), (-69.50,44.00), (-69.23,47.45), (-68.00,47.00),
           (-67.79,47.06), (-67.00,44.00), (-67.50,43.50), (-68.00,43.00), (-69.00,43.00), (-70.00,43.50),
           (-71.08,43.08)],
}
